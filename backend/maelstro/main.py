...
def get_record_ids(credentials_username: str = 'testadmin', credentials_password: str = 'testadmin', server="http://gateway:8080/geonetwork/srv/api/"):
...
def put_record(uuid: str, source_server: str, src_cred='admin', target_server="http://gateway:8080/geonetwork/srv/api", tgt_cred='testadmin', overwrite: bool = True):

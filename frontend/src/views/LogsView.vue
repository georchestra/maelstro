...
import type { Log, LogDetail } from '@/services/logs.service'
...
<template>
  <div class="flex flex-col gap-5 items-center">
    ...
    >
      ...
      <Column field="src_name" header="Source"></Column>
      <Column field="dst_name" header="Destination"></Column>
    </DataTable>
    <div v-if="selectedLog" class="m-5">
      <div class="flex flex-col gap-1">
        ...
        <div class="flex flex-row gap-5">
          <div>details:</div>
          <div>
            {{ selectedLog.details[selectedLog.details.length - 1].message }}
          </div>
        </div>
      </div>
